...
namespace immonex\WordPressFreePluginCore\V2_13_1;
	...
	public function frontend_scripts_and_styles() {
		...
		if ( apply_filters( "{$this->plugin_prefix}use_default_skin_assets_as_fallback", true ) ) {
			...
			wp_enqueue_style(
				...
				$default_skin_css_url,
				[ wp_style_is( $this->frontend_base_css_handle ) ? $this->frontend_base_css_handle : null ],
				$this->plugin_version
			);
		}
