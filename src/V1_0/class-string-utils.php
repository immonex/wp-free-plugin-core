<?php
/**
 * This file contains a utility class for string related methods.
 */
...
class String_Utils {
	...
	public static function transliterate_non_ascii( $text, $german = false ) {
		$trans = array (
			'Ä' => 'Ae', 'ä' => 'ae', 'Æ' => 'Ae', 'æ' => 'ae', 'À' => 'A', 'à' => 'a', 'Á' => 'A',
			'á' => 'a', 'Â' => 'A', 'â' => 'a', 'Ã' => 'A', 'ã' => 'a', 'Å' => 'A', 'å' => 'a',
			'ª' => 'a', 'ₐ' => 'a', 'ā' => 'a', 'Ć' => 'C', 'ć' => 'c', 'Ç' => 'C', 'ç' => 'c',
			'Ð' => 'D', 'đ' => 'd', 'È' => 'E', 'è' => 'e', 'É' => 'E', 'é' => 'e', 'Ê' => 'E',
			'ê' => 'e', 'Ë' => 'E', 'ë' => 'e', 'ₑ' => 'e', 'ƒ' => 'f', 'ğ' => 'g', 'Ğ' => 'G',
			'Ì' => 'I', 'ì' => 'i', 'Í' => 'I', 'í' => 'i', 'Î' => 'I', 'î' => 'i', 'Ï' => 'Ii',
			'ï' => 'ii', 'ī' => 'i', 'ı' => 'i', 'I' => 'I', 'Ñ' => 'N', 'ñ' => 'n', 'ⁿ' => 'n',
			'Ò' => 'O', 'ò' => 'o', 'Ó' => 'O', 'ó' => 'o', 'Ô' => 'O', 'ô' => 'o', 'Õ' => 'O',
			'õ' => 'o', 'Ø' => 'O', 'ø' => 'o', 'ₒ' => 'o', 'Ö' => 'Oe', 'ö' => 'oe', 'Œ' => 'Oe',
			'œ' => 'oe', 'ß' => 'ss', 'Š' => 'S', 'š' => 's', 'ş' => 's', 'Ş' => 'S', '™' => 'TM',
			'Ù' => 'U', 'ù' => 'u', 'Ú' => 'U', 'ú' => 'u', 'Û' => 'U', 'û' => 'u', 'Ü' => 'Ue',
			'ü' => 'ue', 'Ý' => 'Y', 'ý' => 'y', 'ÿ' => 'y', 'Ž' => 'Z', 'ž' => 'z', '¢' => 'Cent',
			'€' => 'Euro', '‰' => 'promille', '№' => 'Nr', '$' => 'Dollar', '℃' => 'Grad Celsius',
			'°C' => $german ? 'Grad Celsius' : 'degrees Centigrade',
			'℉' => $german ? 'Grad Fahrenheit' : 'degrees Fahrenheit',
			'°F' => $german ? 'Grad Fahrenheit' : 'degrees Fahrenheit',	'⁰' => '0',	'¹' => '1',
			'²' => '2', '³' => '3', '⁴' => '4', '⁵' => '5', '⁶' => '6', '⁷' => '7',	'⁸' => '8',
			'⁹' => '9', '₀' => '0', '₁' => '1', '₂' => '2', '₃' => '3', '₄' => '4', '₅' => '5',
			'₆' => '6', '₇' => '7', '₈' => '8', '₉' => '9', '±' => 'plusminus',	'×' => 'x',
			'₊' => 'plus', '₌' => '=', '⁼' => '=', '⁻' => '-', '₋' => '-', '–' => '-',	'—' => '-',
	...
	public static function get_excerpt( $source_text, $length = 120, $suffix = '' ) {
		...
		foreach ( $words as $word ) {
			if ( strlen( $text ) + 1 + strlen( $word ) <= $length ) $text .= ' ' . $word;
			else break;
		}

		if ( $suffix && strlen( $text ) < strlen( $raw ) ) $text .= $suffix;
	...
	public static function is_virtual_tour_url( $url, $additional_search_terms = array() ) {
		if ( ! is_array( $additional_search_terms ) ) $additional_search_terms = array( $additional_search_terms );
		if ( count( $additional_search_terms ) > 0 ) $additional_search_terms = implode( '|', $additional_search_terms );
