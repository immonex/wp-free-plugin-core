...
class Cache_Buster {
	...
	public function init() {
		...
		if ( is_plugin_active( 'autoptimize/autoptimize.php' ) ) {
			add_filter( 'autoptimize_filter_js_exclude', [ $this, 'autoptimize_exclude' ], 20 );
			add_filter( 'autoptimize_filter_css_exclude', [ $this, 'autoptimize_exclude' ], 20 );
		}
	} // init
	...
	/**
	 * Exclude plugin JS/CSS from Autoptimize "optimizations" (filter callback).
	 *
	 * @since 2.6.0
	 *
	 ...
	 */
	public function autoptimize_exclude( $value ) {
		$exclude_string = 'immonex';

		if ( false === strpos( $value, $exclude_string ) ) {
