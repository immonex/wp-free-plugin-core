<?php
/**
 * This file contains the main class of the minimal immonex plugin skeleton.
 */
...
class My_Plugin extends \immonex\WordPressFreePluginCore\V0_9_0\Base {
	...
	public function register_plugin_settings() {
		...
		$tabs = apply_filters( $this->plugin_slug . '_option_tabs', array(
			'tab_general' => array(
		...
		foreach ( $fields as $field ) {
			...
			if ( isset( $field['args'] ) ) $args = array_merge( $args, $field['args'] );
