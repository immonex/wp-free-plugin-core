...
```json
    "require": {
        "immonex/wp-free-plugin-core": "^2.12.2"
    },
```
...
```php
class Example_Plugin extends \immonex\WordPressFreePluginCore\V2_12_2\Base {
...
├── V1_0_0   │ optional PB
├── V1_1_0   │ optional PB
└── V2_12_2 ─┘ Latest Production Branch (PB), NS: immonex\WordPressFreePluginCore\V2_12_2
```
