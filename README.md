...
```json
    "require": {
        "immonex/wp-free-plugin-core": "^2.13.7"
    },
```
...
```php
class Example_Plugin extends \immonex\WordPressFreePluginCore\V2_13_7\Base {
...
├── V1_0_0   │ optional PB
├── V1_1_0   │ optional PB
└── V2_13_7 ─┘ Latest Production Branch (PB), NS: immonex\WordPressFreePluginCore\V2_13_7
```
