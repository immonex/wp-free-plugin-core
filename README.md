...
```json
    "require": {
        "immonex/wp-free-plugin-core": "^2.3.2"
    },
```
...
```php
class Example_Plugin extends \immonex\WordPressFreePluginCore\V2_3_3\Base {
...
├── V1_0_0   │ optional PB
├── V1_1_0   │ optional PB
└── V2_3_3 ──┘ Latest Production Branch (PB), NS: immonex\WordPressFreePluginCore\V2_2_3
```
