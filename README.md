...
```json
    "require": {
        "immonex/wp-free-plugin-core": "^2.13.0"
    },
```
...
```php
class Example_Plugin extends \immonex\WordPressFreePluginCore\V2_13_0\Base {
...
├── V1_0_0   │ optional PB
├── V1_1_0   │ optional PB
└── V2_13_0 ─┘ Latest Production Branch (PB), NS: immonex\WordPressFreePluginCore\V2_13_0
```
