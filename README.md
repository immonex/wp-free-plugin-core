...
```json
    "require": {
        "immonex/wp-free-plugin-core": "^2.10.0"
    },
```
...
```php
class Example_Plugin extends \immonex\WordPressFreePluginCore\V2_10_0\Base {
...
├── V1_0_0   │ optional PB
├── V1_1_0   │ optional PB
└── V2_10_0 ─┘ Latest Production Branch (PB), NS: immonex\WordPressFreePluginCore\V2_10_0
```
