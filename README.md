...
```json
    "require": {
        "immonex/wp-free-plugin-core": "^2.3.1"
    },
```
...
```php
class Example_Plugin extends \immonex\WordPressFreePluginCore\V2_3_1\Base {
...
├── V1_0_0   │ optional PB
├── V1_1_0   │ optional PB
└── V2_3_1 ──┘ Latest Production Branch (PB), NS: immonex\WordPressFreePluginCore\V2_2_3
```
